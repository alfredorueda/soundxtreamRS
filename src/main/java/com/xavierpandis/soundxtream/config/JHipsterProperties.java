...
public class JHipsterProperties {
    ...
    public static class Mail {
        ...
        private String from = "soundxtreamapp@localhost";
    ...
    public static class Swagger {
        ...
        private String title = "soundxtreamapp API";

        private String description = "soundxtreamapp API documentation";
    ...
    public static class Metrics {
        ...
        public static class Graphite {
            ...
            private String prefix = "soundxtreamapp";
