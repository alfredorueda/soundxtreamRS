...
import com.xavierpandis.soundxtream.config.liquibase.AsyncSpringLiquibase;
...
@Configuration
@EnableJpaRepositories("com.xavierpandis.soundxtream.repository")
@EnableJpaAuditing(auditorAwareRef = "springSecurityAuditorAware")
@EnableTransactionManagement
@EnableElasticsearchRepositories("com.xavierpandis.soundxtream.repository.search")
